...
export function ImageStructureCard() {
  ...
  const strength = useStore(
    (state) => state.generateImageRequest.structure?.strength ?? 50
  );
      ...
      <CardFooter className='flex justify-between'>
        ...
        <label htmlFor='upload-image' title='Upload A Reference Image'>
          <Button
            ...
            variant='outline'
            onClick={() =>
              document.getElementById('upload-image-structure')?.click()
            }
          >
